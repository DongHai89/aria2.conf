...
files_num=$2
task_id=$1
downloadpath='/root/download' # 下载目录-需要和aria2一致
log_dir="/etc/aria2"  # 这里是存放log的地方-默认和aria放在一起
rclone_dest="od"        # rclone的disk名称-需要修改
rpc_pwd="46f3eba57eeb70814486"           # aria2的rpc的密码-需要修改
rpc_url="http://45.141.100.235:81/#!/settings/rpc/set/ws/45.141.100.235/6800/jsonrpc/NDZmM2ViYTU3ZWViNzA4MTQ0ODY=" # aria2的rpc地址--需要修改
